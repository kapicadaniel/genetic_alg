...
class Net:
    ...
    def simulate(self, duration=1*60, time_step=1):
        ...
        return self.total_wait_time, len(self.demand), self.num_serviced_passengers, unserviced_passengers_number, (self.total_wait_time/self.num_serviced_passengers)
